...
const TopText = () => {
    return (
        <div className="flex flex-col justify-center h-screen px-60" style={{ backgroundColor: '#383896' }}>
            <div className="text-left max-w-prose">
                ...
                <h1 className="text-3xl font-bold text-white py-4">PROJECT PORTFOLIO</h1>
            </div>
        </div>
    )
}
